...
public class ProductApi {
	...
	@Operation(summary = "Get a product by id", description = "For administration and shop purpose. Specifying ?merchant is required otherwise it falls back to DEFAULT")
	@ApiResponses(value = {
	...
	**/
	...
	@Operation(summary = "Calculate product price with variants", description = "Product price calculation from variants")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Price calculated", content = @Content(schema = @Schema(implementation = ReadableProductPrice.class))) })
	@ResponseBody
	@Parameters({ @Parameter(name = "store", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "DEFAULT")),
			@Parameter(name = "lang", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "en")) })
	...
	**/
	...
	@Operation(summary = "Get a product by friendlyUrl (slug)", description = "For administration and shop purpose. Specifying ?merchant is " + "required otherwise it falls back to DEFAULT")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Single product found", content = @Content(schema = @Schema(implementation = ReadableProduct.class))) })
	@ResponseBody
	@Parameters({ @Parameter(name = "store", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "DEFAULT")),
	...
	@Parameters({ @Parameter(name = "store", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "DEFAULT")),
			@Parameter(name = "lang", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "en")) })
	@Operation(summary = "Patch product sort order", description = "Change product sortOrder")
