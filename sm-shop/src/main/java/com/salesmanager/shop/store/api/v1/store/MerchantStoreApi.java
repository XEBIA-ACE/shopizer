...
public class MerchantStoreApi {
	...
	@Operation(summary = "Get merchant store")
	...
	@Operation(summary = "Get merchant store full details")
	...
	@Operation(summary = "Get retailer child stores", description = "Merchant (retailer) can have multiple stores")
	@Parameters({ @Parameter(name = "lang", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "en")) })
	...
	@Operation(summary = "Get list of stores. Returns all retailers and stores. If superadmin everything is returned, else only retailer and child stores.")
	@Parameters({ @Parameter(name = "lang", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "en")) })
	...
	@Operation(summary = "Get list of store names. Returns all retailers and stores")
	...
	@Operation(summary = "Get list of store supported languages.")
	...
	@Operation(summary = "Updates a store")
	...
	@Operation(summary = "Get store branding and marketing details")
	...
	@Operation(summary = "Get child stores")
	@Parameters({ @Parameter(name = "lang", in = ParameterIn.QUERY, schema = @Schema(type = "string", defaultValue = "en")) })
	...
	@Operation(summary = "Create or save store branding and marketing details")
	...
	@Operation(summary = "Add store logo")
	...
	@Operation(summary = "Delete store logo")
	...
	@Operation(summary = "Check if store code already exists")
