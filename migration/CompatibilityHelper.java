...
// TODO: Replace annotations with springdoc-openapi equivalents
...
public class PaymentApi {
	...
	@ApiOperation(httpMethod = "GET", value = "List of payment modules", notes = "Requires administration access", produces = "application/json", response = List.class)
	...
	public void configure(
		...
		try {
			...
			LOGGER.error("Error saving payment module", e);
	...
	private IntegrationModuleSummaryEntity integrationModule(IntegrationModule module,
		...
		IntegrationModuleSummaryEntity readable = new IntegrationModuleSummaryEntity();
